...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (sport === "mlb") {
      ...
      fetch(`https://site.api.espn.com/apis/v2/sports/football/nfl/scoreboard?dates=${yyyymmdd}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <div className="max-w-4xl mx-auto py-10 px-4">
        ...
        >
          Poisson Sports Models
        </motion.h1>

        <Card className="bg-neutral-900 border border-neutral-700 rounded-2xl shadow-lg p-6 mb-8">
          <CardContent>
            <div className="grid gap-4">
              ...
              <Button onClick={runModel} className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg py-2">
                Run Model
              </Button>
            </div>
          </CardContent>
        ...
        {results && (
          <Card className="bg-neutral-900 border border-neutral-700 rounded-2xl shadow-lg p-6">
            <CardContent>
